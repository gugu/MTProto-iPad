...
#pragma clang diagnostic pop
        ...
        UIImageView *inputImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, TGIsRetina() ? 0.5 : 0, textField.frame.size.width, textField.frame.size.height)];
        inputImageView.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
