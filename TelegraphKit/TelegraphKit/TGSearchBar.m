...
{
    id bar = [super initWithFrame:frame];
    //[(TGSearchBar *) bar setBackgroundColor:[UIColor redColor]];
    return bar;
}
...
- (void)didAddSubview:(UIView *)subview
{
    ...
    {
        [(UISegmentedControl *)subview setContentPositionAdjustment:UIOffsetMake(0.0f, 0.0f) forSegmentType:UISegmentedControlSegmentAny barMetrics:UIBarMetricsDefault];
    }
