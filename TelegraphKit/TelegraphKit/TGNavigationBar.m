...
- (void)commonInit
{
    ...
    dispatch_once(&onceToken, ^
    {
        if ([UIImage instancesRespondToSelector:@selector(resizableImageWithCapInsets:)])
        {
            ...
            [TGNavigationBar setDefaultNavigationBarBackground:[rawPortrait resizableImageWithCapInsets:UIEdgeInsetsMake(8, 8, 8, 8) resizingMode:UIImageResizingModeStretch] landscapeImage:[rawLandscape resizableImageWithCapInsets:UIEdgeInsetsMake(0, 8, 0, 8) resizingMode:UIImageResizingModeStretch]];
        }
        else
        {
